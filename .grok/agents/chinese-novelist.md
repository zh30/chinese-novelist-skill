...
For author-mode blind reads, spawn `blind-reader` (or `explore` with an exact-path prompt). Never fill `blind-read.md` yourself. Host mapping: [harness-grok-antigravity.md](../../references/harness-grok-antigravity.md).
