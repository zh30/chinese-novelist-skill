...
9. **回写状态**：更新章节摘要、人物状态、伏笔状态与章节进度到 `99-进度仪表盘.md`；**同时更新角色认知状态和压力状态**（见「角色智能体推演」章节）
...
**步骤 1：识别主要角色**
- 从 `01-人物档案.md` 中提取主要角色（通常 2-5 个）
- 主要角色 = 有独立目标 + 会主动行动 + 影响剧情走向的角色

**步骤 2：读取角色上一章的状态**
- 从 `99-进度仪表盘.md` 的"角色状态快照"区域读取
...
- **人物档案**（`01-人物档案.md`）：角色的静态设定（性格、背景、欲望、恐惧）
