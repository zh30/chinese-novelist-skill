...
Version: 3.6.0. This repository is an Agent Skill for ambitious Chinese fiction.
...
See `README.md` for install paths across agents. Grok Build / Antigravity / Pi mapping: `references/harness-grok-antigravity.md`.
