...
[角色沙盘模式](references/14-角色沙盘模式.md) 是 v2.4.0 的核心升级：**每章写正文前，先让关键角色以自己的有限认知发言。**
...
每章重点检查 3-5 项，不让清单变成形式主义。

| 灯色 | 含义 | 示例 |
|------|------|------|
| 红灯 | 不过就不能交付 | 本章没有不可删除的变化、字数不足、无钩子 |
| 黄灯 | 建议优化 | AI 味偏高、对白偏书面、节奏略平 |
| 绿灯 | 完稿阶段检查 | 伏笔回收、人物弧线、整体节奏 |
...
> 最后提醒：好小说不是一次生成出来的。先让人物活，再让剧情走；先把章节写出来，再用检查工具把它磨亮。
